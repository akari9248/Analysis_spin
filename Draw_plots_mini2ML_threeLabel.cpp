...
public:
  ...
  void initialize() override {
    t->Add("/extdisk/zlin/Machine_learning/ML_OUT/train_outdnn_herwig_hadron_spinoff_pythia_fourLabels2_matchedrest_j2pt80_120_4/kto4_selectopt0_Chunk*.root/DNNTrainTree");
    //t->Add("/extdisk/zlin/Machine_learning/ML_OUT/train_outdnn_hadron_spinoff_pythia_fourLabels2_matchedrest_j2pt80_120_3/kto4_selectopt0_Chunk*.root/DNNTrainTree");
    ...
    // t->Add("ML_OUT/"
    //        "train_outdnn_hadron_spinoff_pythia_fourLabels_matchedrest_j2pt80_120/"
...
int main() {
  ...
  string folder = "ML_train_out/jpt80_120/june12_herwig_one1GeVcut/";

  analyzerspinon.finalize("plots/"+folder+"ML_plot.root");
