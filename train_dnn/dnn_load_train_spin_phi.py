...
def main(args):
    ...
    select_item = ["pt3", "eta3", "phi3", "e3", "pt4", "eta4", "phi4", "e4", "pt5", "eta5", "phi5", "e5", "z1", "z2", "kt1", "kt2", "score0", "score1", "score2", "score3", "Phi2"]   
    ...
    for iter in range(iter_num):
        ...
        if mode == "Prediction":
            ...
            # basefolder_name = os.path.basename(dir_path)+"/"   
            folder_name = '/storage/shuangyuan/code/analysis_spin/Machine_learning/ML/Datasets/Prediction_spin_phi/'+basefolder_name
