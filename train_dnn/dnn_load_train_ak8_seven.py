...
def main(args):
    ...
    basefolder_name = os.path.basename(dir_path)+"_SevenLabel1/"    
    ...
    for iter in range(iter_num):
        ...
        if mode == "Train":
            ...
            Y_data0 = dnn.convert_to_one_hot_sevenlabel(Y_data,match_data)
        ...
        if mode == "Prediction":
            folder_name = '/storage/shuangyuan/code/analysis_spin/Machine_learning/ML/Datasets_scale/Prediction_ak8/'+basefolder_name
            if not os.path.exists(folder_name):
                os.makedirs(folder_name)
    ...
    if mode == "Train":
        ...
        model.save("ML/model/Sevenlabel1_"+suffix)
        ######################## roc curve ##############################
        ...
        args.model_path = "ML/model/Sevenlabel1_"+suffix
