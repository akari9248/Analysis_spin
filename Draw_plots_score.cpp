...
public:
  ...
  void analyze() override {
    for(int i=0;i<events->type2_Hadron->size();i++){
      ...
      // double score2_weight[3] = {20,20,1};
      // double score2 = events->score2_Hadron->at(i)*score2_weight[2]*5/(events->score0_Hadron->at(i)*score2_weight[0]+events->score1_Hadron->at(i)*score2_weight[1]+events->score2_Hadron->at(i)*score2_weight[2]);
      ...
      // double score2 = events->score2_Hadron->at(i);
      if(score2>0.35){
