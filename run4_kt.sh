...
for ((i=0; i<${#inputFolders[@]}; i++)); do
    ...
    python3 dnn_load_train_ak8_kt.py --sample_path0 "${outputFolder}/*.root" --entries -1 --mode Prediction --model_path /storage/shuangyuan/code/analysis_spin/Machine_learning/ML/model/Fourlabel1_Private_herwig_spinoff_jinitpt_700_7000_j2pt_130_7000_kt2_2_Inf_k8
