...
inputFolders=(
    # /storage/shuangyuan/code/analysis_spin/dataset/QCD_Pt-15to7000_Flat_herwig7_RunIISummer20UL18
    /storage/xiaoxue/code/data/herwig/Decay_0_spinon_600_Inf_forai/
    /storage/xiaoxue/code/data/herwig/Decay_0_spinoff_600_Inf_forai/
    /storage/shuangyuan/code/analysis_spin/dataset/Private_pythia_pt600toinf_on/
    /storage/shuangyuan/code/analysis_spin/dataset/Private_pythia_pt600toinf_off/
...
for ((i=0; i<${#inputFolders[@]}; i++)); do
    ...
    # python3 dnn_load_train_kt.py --sample_path0 "${outputFolder}/*.root" --entries -1 --mode Prediction --model_path /storage/shuangyuan/code/analysis_spin/Machine_learning/ML/model/Fourlabel1_Private_herwig_spinoff_jinitpt_600_7000_j2pt_130_7000_kt2_2_Inf
