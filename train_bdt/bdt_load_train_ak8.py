...
def main(args):
    ...
    for iter in range(iter_num):
        ...
        if mode == "Train":
            ...
            Y_data0 = dnn.convert_to_one_hot_fourlabel2(Y_data,match_data)
        ...
        if mode == "Prediction":
            folder_name = '/storage/shuangyuan/code/analysis_spin/Machine_learning/ML/Datasets_new/Prediction_ak8/'+basefolder_name
            if not os.path.exists(folder_name):
                os.makedirs(folder_name)
    ...
    if mode == "Train":
        ...
        learning_rate=0.001
        l2_reg=0
        model = dnn.train_and_save_model_bdt(X_train=X_data1_train_full, Y_train=Y_data1_train_full, X_val=X_data1_val_full, Y_val=Y_data1_val_full)
