...
def main(args):
    ...
    select_item = [
        ...
        ["Nparticles_1","Ntracks_1","pTD_1","sigma1_1","sigma2_1","sigma_1","Nparticles_5","Ntracks_5","pTD_5","sigma1_5","sigma2_5","sigma_5","Nparticles_6","Ntracks_6","pTD_6","sigma1_6","sigma2_6","sigma_6","z1","z3","DeltaR3","kt3"]
    ]
