...
def main(args):
    ...
    select_item = ["pt3", "eta3", "phi3", "e3", "pt4", "eta4", "phi4", "e4", "pt1", "eta1", "phi1", "e1", "z1", "z2", "kt1", "kt2", "score0", "score1", "score2", "score3"]
    ...
    for iter in range(iter_num):
        ...
        if mode == "Prediction":
            ...
            # basefolder_name = os.path.basename(dir_path)+"/"   
            folder_name = '/storage/shuangyuan/code/analysis_spin/Machine_learning/ML/Datasets_new/Prediction_ak8_spin/'+basefolder_name
